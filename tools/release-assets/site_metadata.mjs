...
export const RELEASE_ROUTE_METADATA_SCRIPT_PATH = path.posix.join(
  "js",
...
export function buildReleaseMetadataSyncScript(siteMetadata) {
  const metadataJson = JSON.stringify(siteMetadata, null, 2);
