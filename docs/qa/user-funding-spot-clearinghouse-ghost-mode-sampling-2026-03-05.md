# Ghost Mode `/info` Sampling: userFunding + spotClearinghouseState (2026-03-05)

## Scope

Manual browser-inspection sampling on local branch `codex/ws-migration-manual-testing` for Ghost Mode address:
...
- force Ghost Mode active with the target address
