...
- [ ] Milestone 4: retire the remaining oversized account-info exceptions in priority order: `tabs/balances`, `tabs/open_orders`, `tabs/trade_history`, `projections/balances`, `projections/orders`, `position_tpsl_modal`, then the remaining oversized tests (`balances_test`, `open_orders_test`, `order_history_test`, `trade_history_test`).
