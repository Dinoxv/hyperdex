  ...
  (vec
   (concat
    [[:actions/init-websockets :init-websockets]
     ...
     [:actions/open-shadow-mode-modal :open-shadow-mode-modal]
     [:actions/close-shadow-mode-modal :close-shadow-mode-modal]
     [:actions/set-shadow-mode-search :set-shadow-mode-search]
     [:actions/set-shadow-mode-label :set-shadow-mode-label]
     [:actions/start-shadow-mode :start-shadow-mode]
     [:actions/stop-shadow-mode :stop-shadow-mode]
     [:actions/add-shadow-mode-watchlist-address :add-shadow-mode-watchlist-address]
     [:actions/remove-shadow-mode-watchlist-address :remove-shadow-mode-watchlist-address]
     [:actions/edit-shadow-mode-watchlist-address :edit-shadow-mode-watchlist-address]
     [:actions/clear-shadow-mode-watchlist-edit :clear-shadow-mode-watchlist-edit]
     [:actions/copy-shadow-mode-watchlist-address :copy-shadow-mode-watchlist-address]
     [:actions/spectate-shadow-mode-watchlist-address :spectate-shadow-mode-watchlist-address]
