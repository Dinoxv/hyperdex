...
(defn request-spot-clearinghouse-state!
  ...
  (portfolio/request-spot-clearinghouse-state! post-info! address opts))
...
(defn request-user-webdata2!
  [post-info! address opts]
  (agents/request-user-webdata2! post-info! address opts))
...
(defn normalize-user-abstraction-mode
  [abstraction]
  (portfolio/normalize-user-abstraction-mode abstraction))
