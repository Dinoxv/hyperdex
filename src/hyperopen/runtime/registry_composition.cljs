...
(defn- api-effect-handlers
  ...
  {:fetch-asset-selector-markets fetch-asset-selector-markets
   ...
   :api-fetch-hyperunit-withdrawal-queue api-fetch-hyperunit-withdrawal-queue
...
(defn- vault-action-handlers
  ...
  {:load-vault-route load-vault-route
   ...
   :sort-vault-detail-activity sort-vault-detail-activity
   :toggle-vault-detail-activity-filter-open toggle-vault-detail-activity-filter-open
...
(defn- chart-and-orderbook-action-handlers
  [{:keys [toggle-timeframes-dropdown
           ...
           set-portfolio-account-info-tab
  ...
  {:toggle-timeframes-dropdown toggle-timeframes-dropdown
   ...
   :toggle-portfolio-performance-metrics-time-range-dropdown toggle-portfolio-performance-metrics-time-range-dropdown
   ...
   :set-portfolio-account-info-tab set-portfolio-account-info-tab
...
(defn- account-history-action-handlers
  ...
  {:select-account-info-tab select-account-info-tab
   ...
   :add-funding-history-filter-coin add-funding-history-filter-coin
   :handle-funding-history-coin-search-keydown handle-funding-history-coin-search-keydown
