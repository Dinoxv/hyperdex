...
def policyCorpus : List (String × Policy) :=
  ...
  ,("actions/load-referrals-route", defaultPolicy false ["effects/api-fetch-referral"])
  ...
  ,("actions/navigate", defaultPolicy false ["effects/api-fetch-leaderboard", "effects/api-fetch-predicted-fundings", "effects/api-fetch-referral", "effects/api-fetch-staking-delegations", "effects/api-fetch-staking-delegator-summary", "effects/api-fetch-staking-history", "effects/api-fetch-staking-rewards", "effects/api-fetch-staking-spot-state", "effects/api-fetch-staking-validator-summaries", "effects/api-fetch-user-vault-equities", "effects/api-fetch-vault-details", "effects/api-fetch-vault-fills", "effects/api-fetch-vault-funding-history", "effects/api-fetch-vault-index", "effects/api-fetch-vault-index-with-cache", "effects/api-fetch-vault-ledger-updates", "effects/api-fetch-vault-order-history", "effects/api-fetch-vault-summaries", "effects/api-fetch-vault-webdata2", "effects/api-load-api-wallets", "effects/api-load-subaccounts", "effects/fetch-asset-selector-markets", "effects/load-route-module", "effects/load-trade-chart-module", "effects/load-trading-indicators-module"])
  ,("actions/navigate-mobile-header-menu", defaultPolicy false ["effects/api-fetch-leaderboard", "effects/api-fetch-predicted-fundings", "effects/api-fetch-referral", "effects/api-fetch-staking-delegations", "effects/api-fetch-staking-delegator-summary", "effects/api-fetch-staking-history", "effects/api-fetch-staking-rewards", "effects/api-fetch-staking-spot-state", "effects/api-fetch-staking-validator-summaries", "effects/api-fetch-user-vault-equities", "effects/api-fetch-vault-details", "effects/api-fetch-vault-fills", "effects/api-fetch-vault-funding-history", "effects/api-fetch-vault-index", "effects/api-fetch-vault-index-with-cache", "effects/api-fetch-vault-ledger-updates", "effects/api-fetch-vault-order-history", "effects/api-fetch-vault-summaries", "effects/api-fetch-vault-webdata2", "effects/api-load-subaccounts", "effects/fetch-asset-selector-markets", "effects/load-route-module", "effects/load-trade-chart-module", "effects/load-trading-indicators-module"])
  ...
  ,("actions/select-subaccount", defaultPolicy false ["effects/api-load-user-data"])
  ,("actions/select-master-account", defaultPolicy false ["effects/api-load-user-data"])
  ,("actions/submit-create-subaccount", defaultPolicy false ["effects/api-create-subaccount"])
  ,("actions/submit-rename-subaccount", defaultPolicy false ["effects/api-rename-subaccount"])
  ...
  ,("actions/select-portfolio-returns-benchmark", defaultPolicy false ["effects/api-fetch-trader-portfolio-benchmark", "effects/api-fetch-vault-benchmark-details", "effects/fetch-candle-snapshot"])
  ,("actions/select-portfolio-summary-time-range", defaultPolicy true ["effects/api-fetch-trader-portfolio-benchmark", "effects/fetch-candle-snapshot"])
  ...
  ,("actions/submit-claim-referral-rewards", defaultPolicy false ["effects/api-claim-referral-rewards"])
