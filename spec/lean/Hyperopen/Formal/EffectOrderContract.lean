...
def policyCorpus : List (String × Policy) :=
  ...
  ,("actions/load-vault-detail", defaultPolicy false ["effects/api-fetch-vault-details", "effects/api-fetch-vault-fills", "effects/api-fetch-vault-funding-history", "effects/api-fetch-vault-ledger-updates", "effects/api-fetch-vault-order-history", "effects/api-fetch-vault-webdata2"])
  ,("actions/load-vault-route", defaultPolicy false ["effects/api-fetch-user-vault-equities", "effects/api-fetch-vault-benchmark-details", "effects/api-fetch-vault-details", "effects/api-fetch-vault-fills", "effects/api-fetch-vault-funding-history", "effects/api-fetch-vault-index", "effects/api-fetch-vault-index-with-cache", "effects/api-fetch-vault-ledger-updates", "effects/api-fetch-vault-order-history", "effects/api-fetch-vault-summaries", "effects/api-fetch-vault-webdata2"])
