(ns hyperopen.views.account-info.sort-kernel-test
...
(deftest resolve-column-accessor-prefers-column-mapping-and-fallbacks-test
  (let [accessor-by-column {"Coin" (fn [row] (:coin row))}
        mapped-accessor (sort-kernel/resolve-column-accessor "Coin" accessor-by-column)
        ...
        custom-fallback (sort-kernel/resolve-column-accessor "Missing"
                                                             accessor-by-column
                                                             (fn [row] (:fallback row)))]
    (is (= "ETH" (mapped-accessor {:coin "ETH"})))
