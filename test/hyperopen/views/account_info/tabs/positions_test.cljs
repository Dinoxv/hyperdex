  ...
  (with-phone-viewport
    (fn []
      (let [expanded-row (-> (fixtures/sample-position-row "xyz:GOLD" 20 "0.0185" "xyz")
        ...
        (is (contains? (hiccup/node-class-set close-button) "text-trading-text"))
        ...
        (is (contains? (hiccup/node-class-set margin-button) "text-trading-text"))
        (is (contains? (hiccup/node-class-set tpsl-button) "text-trading-text"))
