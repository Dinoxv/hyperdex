...
(deftest runtime-action-deps-uses-extracted-action-adapter-overrides-test
  (let [deps (wiring/runtime-action-deps)
    ...
    (is (identical? (:open-portfolio-optimizer-scenario-save-modal optimizer-action-deps)
                    (get-in deps [:portfolio-optimizer :open-portfolio-optimizer-scenario-save-modal])))
    (is (identical? (:close-portfolio-optimizer-scenario-save-modal optimizer-action-deps)
                    (get-in deps [:portfolio-optimizer :close-portfolio-optimizer-scenario-save-modal])))
    (is (identical? (:set-portfolio-optimizer-scenario-save-name optimizer-action-deps)
                    (get-in deps [:portfolio-optimizer :set-portfolio-optimizer-scenario-save-name])))
    (is (identical? (:confirm-portfolio-optimizer-scenario-save optimizer-action-deps)
                    (get-in deps [:portfolio-optimizer :confirm-portfolio-optimizer-scenario-save])))
