...
(deftest facade-contract-exposes-runtime-action-adapter-surface-test
  ...
  (is (fn? action-adapters/set-portfolio-optimizer-draft-add-asset-open-action))
  (is (fn? action-adapters/handle-portfolio-optimizer-universe-search-keydown-action))
  (is (fn? action-adapters/handle-portfolio-optimizer-draft-add-asset-keydown-action))
  ...
  (is (fn? action-adapters/open-portfolio-optimizer-scenario-save-modal-action))
  (is (fn? action-adapters/close-portfolio-optimizer-scenario-save-modal-action))
  (is (fn? action-adapters/set-portfolio-optimizer-scenario-save-name-action))
  (is (fn? action-adapters/confirm-portfolio-optimizer-scenario-save-action))
  ...
  (is (fn? action-adapters/auto-recompute-stale-portfolio-optimizer-scenario-action))
